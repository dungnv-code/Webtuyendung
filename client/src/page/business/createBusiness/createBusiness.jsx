...
import { creatBusiness } from "../../../api/business";
...
const CreateBusiness = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        setLoading(true);
        try {
            const response = await creatBusiness(formData);
            if (response?.success) {
                setLoading(false);
                Swal.fire({
                    icon: 'success',
                    title: 'Tạo doanh nghiệp thành công!',
                    timer: 2000,
            ...
            Swal.fire({
                icon: "error",
                title: "Lỗi API",
                text: "Không thể tạo doanh nghiệp!"
            });
        }
    };
