...
const Adminsibar = () => {
    ...
    const menuItems = [
        ...
        { text: "Quản lí công việc", icon: <i class="fa-solid fa-briefcase"></i>, to: path.JOBADMIN },
        { text: "Quản lí kĩ năng", icon: <i class="fa-solid fa-lightbulb"></i>, to: path.SKILLADMIN },
        { text: "Quản lí cấp bậc", icon: <RiseOutlined />, to: path.LEVELADMIN },
        { text: "Quản lí hình thức ", icon: <i class="fa-solid fa-briefcase"></i>, to: path.STYLEJOBADMIN },
        { text: "Quản lí khoảng lương", icon: <i class="fa-solid fa-money-bill-wave"></i>, to: path.SALARYRANGEADMIN },
        { text: "Quản lí kinh nghiệm", icon: <i class="fa-solid fa-user-clock"></i>, to: path.EXPADMIN },
        { text: "Quản lí các gói bài đăng", icon: <i class="fa-solid fa-box"></i>, to: path.PACKETPOSTADMIN },
        { text: "Quản lí doanh nghiệp", icon: <i class="fa-solid fa-building"></i>, to: path.COMPANYADMIN },
        { text: "Quản lí bài đăng", icon: <i class="fa-solid fa-file-lines"></i>, to: path.POSTADMIN },
